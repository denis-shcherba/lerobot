...
def main():
    ...
    output_directory = Path("outputs/train/demo_test_deltas")
    ...
    cfg = DiffusionConfig(input_features=input_features_, output_features=output_features_)

    # We can now instantiate our policy with this config and the dataset stats.
    policy = DiffusionPolicy(cfg, dataset_stats=dataset_metadata_.stats)
    policy.train()
    policy.to(device)
